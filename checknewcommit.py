                                                                        ...
                                                                        if result_folder:
                                                                            ...
                                                                            if extension is not None:
                                                                                ...
                                                                                if extension == "py":
                                                                                    ...
                                                                                    files_service.deploy_flask_app(app_name,deploymentdata_forbranch["Env"], os.path.join(deploymentdata_forbranch["Location"],deploymentdata_forbranch["FolderName"]),current_path)
                                                                                    servicename = f"{deploymentdata_forbranch['Env']}_{app_name}"
                                                                                    if not files_service.service_exists(servicename):

                                                                                        gunicorn_sample_path = os.path.join(current_path,"gunicorn_service_sample.txt")
                                                                                        ...
                                                                                        files_service.add_gunicorn_service(deploymentdata_forbranch["Env"],app_name,gunicorn_config_sample)
                                                                                    
                                                                                    if not files_service.nginx_config_exists(servicename):
                                                                                        flask_nignx_sample_path = os.path.join(current_path,"flask_nginx_config_server_sample.txt")
                                                                                        ...
                                                                                        files_service.add_nginx_config(servicename,app_name,flak_config_sample)
                                                                                    ...
                                                                                    runbash_service.restart_all_service(app_name)
